<template>
  <div class="w100 tab-content-item lavel" v-if="!active">
    ...
    <div class="trend">
      ...
      <div class="w100 levelChart" id="levelChart2"></div>
    </div>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    ...
    //折线图统计
    drawlevelChart2(xData, yData1) {
      let el = document.getElementById("levelChart2");
      if (!el) {
        return;
      }
      // eslint-disable-next-line no-undef
      this.levelChart = echarts.init(el);
      let option = {
        tooltip: {
          trigger: "axis",
      ...
      this.levelChart && this.levelChart.clear();
