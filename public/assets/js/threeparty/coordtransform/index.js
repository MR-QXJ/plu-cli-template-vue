/*
 * 地图坐标转换
 * author: Created by Wandergis on 2015/7/8
...
window.CoordTransform = (function() {
  ...
  // 百度坐标转国测局坐标
  CoordTransform.prototype.BDToGCJ = function(lon, lat) {
    return bd09togcj02(lon, lat);
  }

  // 国测局坐标转百度坐标
  CoordTransform.prototype.GCJToBD = function(lon, lat) {
    return gcj02tobd09(lon, lat);
  }

  // WGS坐标转国测局坐标
  CoordTransform.prototype.WGSToGCJ = function(lon, lat) {
    return wgs84togcj02(lon, lat);
  }

  // 国测局坐标转WGS坐标
  CoordTransform.prototype.GCJToWGS = function(lon, lat) {
